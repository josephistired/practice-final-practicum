...
def test_create_book():
  ...
  # analyze
  assert title == book.getTitle()
  assert author == book.getAuthor()
  assert publication_year == book.getPublicationYear()
...
def test_return_book():
  ...
  # analyze
  assert not library.is_empty()
  assert library.getBooks()[0] == book
...
#   # analyze
#   assert book4 == library.getBooks()[0]
#   assert book5 == library.getBooks()[1]
#   assert book2 == library.getBooks()[2]
#   assert book1 == library.getBooks()[3]
#   assert book3 == library.getBooks()[4]
...
def test_organize_library_duplicates():
  ...
  # analyze
  assert book2 == library.getBooks()[0]
  assert book1 == library.getBooks()[1]
  assert book5 == library.getBooks()[2]
  assert book4 == library.getBooks()[3]
  assert book3 == library.getBooks()[4]